...
import com.l99.chinafootball.adapter.FivePepleListAdapter;
...
public class FivePeopleFragment extends BaseFragment implements IView.ViewPro<ArrayList<ArrayList<RefereesBean.CategoryBean.RefereeBean>>> {
    ...
    private FivePepleListAdapter mAdapter;

    public FivePeopleFragment(Context context) {
        super(context);
    ...
    public void setData(ArrayList<ArrayList<RefereesBean.CategoryBean.RefereeBean>> data) {
        mAdapter = new FivePepleListAdapter(data);
