...
public class AppearanceRecordsFragment extends BaseFragment {
    ...
    public String getTAG() {
        return AppearanceRecordsFragment.class.getSimpleName();
    }

    public AppearanceRecordsFragment(Context context, BasicPlayerBean playersBean) {
        super(context);
    ...
    public void initData() {
        ...
        String introduce = playersBean.getCompetition_record();
