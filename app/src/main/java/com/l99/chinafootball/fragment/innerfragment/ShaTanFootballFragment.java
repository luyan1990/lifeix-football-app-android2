...
import com.l99.chinafootball.adapter.ShaTanFootballListAdapter;
...
public class ShaTanFootballFragment extends BaseFragment implements IView.ViewPro<ArrayList<ArrayList<RefereesBean.CategoryBean.RefereeBean>>>  {
    ...
    private ShaTanFootballListAdapter mAdapter;

    public ShaTanFootballFragment(Context context) {
        super(context);
    ...
    public void setData(ArrayList<ArrayList<RefereesBean.CategoryBean.RefereeBean>> data) {
        mAdapter = new ShaTanFootballListAdapter(data);
