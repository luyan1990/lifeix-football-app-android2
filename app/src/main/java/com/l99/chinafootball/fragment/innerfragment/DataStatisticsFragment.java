...
public class DataStatisticsFragment extends BaseFragment {
    ...
    public String getTAG() {
        return DataStatisticsFragment.class.getSimpleName();
    }

    public DataStatisticsFragment(Context context, BasicPlayerBean playersBean) {
        super(context);
    ...
    public void initData() {
        ...
        String introduce = playersBean.getData_statisitic();
