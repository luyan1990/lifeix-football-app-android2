...
public class CompetitionApi {
    ...
    public void getCompetition(String key,long id , final IModel.ModelApiListener<CompetitionBean> listener) {
//      http://192.168.50.154:8000/football/games/competitionCategory/8089916318445/lastestCompetition?key=visitor
       String url = this.url + "/"+id+"/lastestCompetition"+"?key="+key;
        LogUtil.e(url);
        listener.onLoading();
        HttpUtils.get(url, new HttpUtils.HttpListener() {
            @Override
            public void onSuccess(String json) {
                competitionBean = processCompetition(json);
        ...
        try {
            ...
            for(int i = 0; i < matches_array.length(); i++) {
               ...
               JSONObject match = (JSONObject) matches_array.get(i);
                int match_awayScore = match.optInt("awayScore");
                ...
                String match_awayTeam_desc = match_awayTeam.optString("desc");
                ...
                awayTeamBean.setDesc(match_awayTeam_desc);
                ...
                int match_hostScore = match.optInt("hostScore");
                ...
                String match_hostTeam_desc = match_hostTeam.optString("desc");
                ...
                hostTeamBean.setDesc(match_hostTeam_desc);
                ...
                int match_state = match.optInt("state");
                ...
                matchesBean.setState(match_state);
