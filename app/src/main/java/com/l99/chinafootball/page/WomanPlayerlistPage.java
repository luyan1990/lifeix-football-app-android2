...
public class WomanPlayerlistPage extends BaseFragment implements  IView.ViewPro<ArrayList<Map<String, ArrayList<NationalPlayerBean.CategoryBean.PlayersBean>>>> {
    ...
    public WomanPlayerlistPage(Context context) {
        super(context);
    ...
    public String getTAG() {
        return FragmentSwitcher.WOMAN_PLAYERLIST_PAGE;
    }
    ...
    public void setData(ArrayList<Map<String, ArrayList<NationalPlayerBean.CategoryBean.PlayersBean>>> data) {
        Map<String, ArrayList<NationalPlayerBean.CategoryBean.PlayersBean>> map1 = data.get(1);

        ArrayList<NationalPlayerBean.CategoryBean.PlayersBean> playersBeans1 = map1.get("国家队");
        ArrayList<NationalPlayerBean.CategoryBean.PlayersBean> playersBeans2 = map1.get("国青队");
        ArrayList<NationalPlayerBean.CategoryBean.PlayersBean> playersBeans3 = map1.get("国少队");
